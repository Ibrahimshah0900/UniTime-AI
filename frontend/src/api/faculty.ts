...
export const facultyApi = {
  ...
  managedAssignments: (facultyUserId?: number) => apiRequest<FacultyAssignment[]>(`/faculty-assignments${queryString({ faculty_user_id: facultyUserId })}`),
  addAssignment: (payload: { faculty_user_id: number; course_code: string; section: string; semester: string }) =>
